...
public class ImageUtility {
	...
	public static void resize(File src, File dest, int width, int height, String extName) 
			throws IOException{
	...
	public static void resize(InputStream originalFile, 
			File smallFilePath, int width, int height, String extName) 
			throws IOException{
