...
public class MembershipController {
	...
	public String idDupCheck(HttpServletRequest request){
		...
		int chkPoint = sqlSession.selectOne("dystopia.dupIdCnt", 
				request.getParameter("user_id"));//해당되는 아이디 갯수
		
		if(chkPoint == 0)//해당 아이디가 없을경우
			return "0";
		else //해당 아이디가 있을경우
			return "1";
	}
	...
	public ModelAndView insert(@Valid UserInfo userinfo, HttpSession session, 
			MultipartHttpServletRequest mRequest) {

		System.out.println("컨트롤러는 탔냐?");
...
//		Rank rank = new Rank();
		...
		// 빈에 set
//		userInfo.setUsnumber(usnumber);
//		userInfo.setUsname(name);
//		userInfo.setUsid(id);
//		userInfo.setUspassword(pw);
//		userInfo.setUsbirthday(birthday);
//		userInfo.setUsgender(hgender);
//		userInfo.setUsaddress(addr);
//		userInfo.setUsemail(email);
//		userInfo.setUsphone(phone);
//		userInfo.setUstreasure(treasure);
//		
//		rank.setRank_number(rankNumber);
//		rank.setUs_number(usnumber);
//		rank.setRank_kitchen(0);
//		rank.setRank_life(0);
//		rank.setRank_tv(0);
//		rank.setRank_digitalcamera(0);
//		rank.setRank_desktop(0);
//		rank.setRank_notebook(0);
//		rank.setRank_2in1(0);
//		rank.setRank_peripheral_com(0);
//		rank.setRank_smartphone(0);
//		rank.setRank_tablet(0);
//		rank.setRank_smartwatch(0);
//		rank.setRank_peripheral_smart(0);
//		rank.setRank_furniture(0);
//		rank.setRank_clothing(0);
//		rank.setRank_sport(0);
//		rank.setRank_stationery(0);
